...
func newSimpleView(vol *Vol) (view *proto.SimpleVolView) {
	...
	view = &proto.SimpleVolView{
		...
		DpStatusUpdateIntervalSec:        vol.dpStatusUpdateIntervalSec,
		DpSnapshotIntervalSec:            vol.dpSnapshotIntervalSec,
		DpUpdateReplicaIntervalSec:       vol.dpUpdateReplicaIntervalSec,
		DpUpdatePartitionSizeInternalSec: vol.dpUpdatePartitionSizeInternalSec,
		MpSyncCursorInternalSec:          vol.mpSyncCursorInternalSec,
		MpPersistDataInternalSec:         vol.mpPersistDataInternalSec,
	}
...
func (m *Server) getMetaPartition(w http.ResponseWriter, r *http.Request) {
	...
	var toInfo = func(mp *MetaPartition) *proto.MetaPartitionInfo {
		...
		var mpInfo = &proto.MetaPartitionInfo{
			...
			SyncCursorInternalSec:  mp.SyncCursorInternalSec,
			PersistDataInternalSec: mp.PersistDataInternalSec,
		}
		return mpInfo
	}
